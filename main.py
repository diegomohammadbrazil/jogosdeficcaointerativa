...
if(__name__ == "__main__"): # Pesquisar significado desse if
    ...
    while True:
        ...
        if(opcao == "1"):
            ...
            if(casa.suplemento > 0):
                casa.suplemento -= 1
                personagem.tomousuplemento = True
            else:
                print("Não tem suplemento na sua casa")
            relogio.avancaTempo(5)
        elif(opcao == "6"):
            if(personagem.dinheiro >= 20):
                ...
                print("A cartela com 10 suplmentos custa 20 reais, você não tem dinheiro suficiente.")
                relogio.avancaTempo(5)
        elif(opcao == "7"):
            print("-=-=-")
            ...
            if(not personagem.tomousuplemento):
